        ...
        <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-darkbg-card rounded-2xl shadow-glass border border-slate-100 dark:border-darkbg-border overflow-hidden z-50 py-1 transition-all duration-200">
          ...
          <div className="py-1">
            <button
              ...
              className="w-full text-left px-4 py-2 text-xs text-slate-700 dark:text-slate-350 hover:bg-slate-50 dark:hover:bg-slate-800/40 flex items-center gap-2 transition-colors"
            >
              <UserIcon className="h-4 w-4 text-slate-400" /> Profile Details
            </button>
            <button
              onClick={() => {
                setIsOpen(false);
